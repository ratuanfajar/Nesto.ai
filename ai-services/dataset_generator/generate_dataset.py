...
# Rendering isometrik CAD (matplotlib)
...
# Rendering multi-view 2D ortografik (tampak depan / samping)
...
def apply_realistic_paper_effects(img_path: str):
    """Jitter rotasi + noise + variasi kontras/kecerahan agar mirip foto kertas."""
...
def generate_full_dataset(total_samples=1500, output_dir="./dataset_output", seed=42):
    ...
    for idx in tqdm(range(total_samples)):
        ...
        # Acak koma/titik pada label gambar agar model robust.
        ...
        # Pesan ChatML untuk Qwen2-VL; path relatif POSIX agar portabel.
