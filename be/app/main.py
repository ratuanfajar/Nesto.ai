...
async def lifespan(app: FastAPI):
    # Load di startup, bukan saat request pertama: bobot rusak ketahuan lewat /ready.
    try:
...
async def read_image(upload: UploadFile) -> Image.Image:
    ...
    try:
        ...
        # exif_transpose: tanpa ini foto HP masuk miring 90 derajat.
...
def ensure_spec_usable(spec, from_model: bool = False) -> None:
    """Tolak spesifikasi berdimensi <= 0 (mis. contoh bawaan Swagger yang kosong)."""
